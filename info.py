...
PICS = (environ.get('PICS', 'https://envs.sh/oJj.jpg')).split()
...
support_chat_id = environ.get('SUPPORT_CHAT_ID','-1002146128308')
...
MAX_BTN = int(environ.get('MAX_BTN', "11"))
S_GROUP = environ.get('S_GROUP',"https://t.me/+vg2zU33d_1c2YmQ1")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/UrvashiTheaters_Main")
MOVIE_GROUP = environ.get('MOVIE_GROUP',"https://t.me/+vg2zU33d_1c2YmQ1")
...
NORES_CHANNEL = int(environ.get('NORES_CHANNEL', 0))
PM_CHANNEL = int(environ.get('PM_CHANNEL', 0))
